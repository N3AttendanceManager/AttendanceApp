...
class ClassViewModel @Inject constructor(
    ...
    val subjectId = _subjectId.asStateFlow()
    ...
    fun fetchClassList() {
        viewModelScope.launch(Dispatchers.IO) {
            classRepository.getAtClassList(subjectId = subjectId.value!!).mapBoth(
    ...
    fun fetchSubject() {
        viewModelScope.launch(Dispatchers.IO) {
            subjectRepository.getSubject(subjectId = subjectId.value!!).mapBoth(
